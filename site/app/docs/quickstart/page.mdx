...
Node 18+ required. Every framework integration is an optional peer
...
See **[Monitors](/docs/monitors)** for the full story on reconnect
resume, replica fan-out, and the production capture → snapshot →
replay flow this was built for.
